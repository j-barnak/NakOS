...
ColorCode::ColorCode(VGA_Color foreground, VGA_Color background) : color{ determine_color(foreground, background) }
{}

ColorCode::ColorCode() : ColorCode(VGA_Color::Green, VGA_Color::Red)
{}
